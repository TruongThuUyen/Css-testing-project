...
const renderBanner = () => {
  ...
  bannerSlides.forEach((slide) => {
    splideListEl.innerHTML += `
        <li key=${slide.id}
          class="splide__slide relative z-1 flex flex-col justify-end max-w-[var(--container-width)] h-[720px] px-12 pb-[50px] bg-[linear-gradient(180deg,rgba(25,25,25,0)_52.85%,#191919_100%),url('${slide.url}')] bg-cover bg-center">
          <div class="flex items-end justify-between mb-10">

            <!-- Left Content -->
            <div class="text-white">
              <h1 class="max-w-[429px] mb-6 text-6xl md:text-7xl xl:text-[120px] font-bold uppercase line-height-normal">${slide.title}</h1>
              <div class="flex items-center gap-3 text-[var(--primary-text-color)]">
                <span class="text-sm max-w-[347px] h-[54px] leading-[18px]">
                 ${slide.description}
                </span>
                <button
                  ...
                  <span
                    class="relative z-10 text-[var(--primary-text-color)] text-base leading-[20px] w-[107px] h-[20px] font-medium text-center whitespace-nowrap overflow-hidden">
                    Find out more
                  </span>
                </button>
              </div>
            ...
            <!-- Right Content -->
            <div class="relative max-w-[382px] -mb-10">
              <!-- Shadow Layer -->
              <div
                class="absolute w-[100px] h-[100px] left-[110px] top-[-45px] [background:radial-gradient(50%_50%_at_50%_50%,#E30613_0%,#009FE3_100%)] blur-[50px]"></div>
              <div
                class="absolute w-[168px] h-[168px] left-[163px] top-[0] [background:radial-gradient(50%_50%_at_50%_50%,rgba(0,159,227,0.5)_0%,rgba(227,6,19,0.5)_100%)] blur-[50px]"></div>

              <!-- Flag item -->
              <img
                src="./assets/images/flag.png"
                alt="Racing flag"
                class="absolute bottom-[98px] left-[-14px] w-[87px] h-[87px] z-1 object-cover" />
              ...
              <!-- Phone Number -->
              <div class="absolute top-[131px] right-[5px]">
                <div
